...
| **적용 대상** | Premium/General만 (VIP, Main Day, AP 제외) | Premium/General만 (VIP, Main Day, AP 제외) | — |
| **Shopify 코드** | `EARLYBIRD20` | `EARLYBIRD10` | 없음 |

> **VIP와 Main Day는 모든 얼리버드 할인 대상이 아닙니다.** 항상 정가로 판매됩니다
> (VIP ₩2,400,000 / Main Day ₩140,000). 코드상 `lib/pricing.ts`의 `NO_DISCOUNT_TIERS`가 이를 강제합니다.
...
| Main Day | ₩140,000 | — (할인 대상 아님) | — (할인 대상 아님) |
