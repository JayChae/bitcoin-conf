...
const enItems: Speaker[] = [
  ...
  },
  {
    ...
    difficulty: "Low",
    links: [
      { type: "youtube", url: "https://youtube.com/channel/UC1f_j9wOASvYAvADpwTXT0Q?si=OrewibwreA03-_Ff" },
...
const koItems: Speaker[] = [
  ...
  },
  {
    ...
    title: "리스펙",
    subtitle: "비트코인 유튜버",
    bio: "비트코인의 본질과 변동성을 이해하고, 이를 장기투자 관점으로 풀어내는 유튜브 '리스펙 투자플랜' 채널을 운영하고 있다. 18만 구독자와 함께 다양한 콘텐츠를 통해, 비트코인을 지켜낼 수 있는 마인드를 전하고 있다.",
    lectureTitle: "",
    difficulty: "하",
    links: [
      { type: "youtube", url: "https://youtube.com/channel/UC1f_j9wOASvYAvADpwTXT0Q?si=OrewibwreA03-_Ff" },
  ...
  },
  {
    ...
    image: "/2026/speakers/poedae.webp",
    title: "고덕윤 (포대)",
    subtitle: "대표 | 논스랩 · 코코넛 월렛 · 비트코인 센터 서울",
    bio: "코코넛월렛과 비트코인 센터 서울을 운영하는 논스랩의 설립자로 대학과 기업에서 비트코인을 가르치는 강사로 활동 중에 있으며, 모바일 월렛 개발을 위한 오픈소스 라이브러리 coconut_lib의 메인 개발자이다.\n\n논스랩(주) 대표이사\n서강대학교 AI/SW 대학원 겸임교수\n한국금융연수원 겸임교수",
    lectureTitle: "",
    difficulty: "중",
    links: [
      { type: "x", url: "https://x.com/Coconut_BTC" },
...
const speakers = { ko: koItems, en: enItems };
