...
import { snsIconUrl, Speaker } from "@/app/messages/2025/speakers";
        ...
        >
          ...
          <footer className="relative z-10 p-3 text-white font-sans flex flex-col">
            <div className="flex justify-between items-center">
              <h3 className="text-sm md:text-[1.05rem] font-semibold text-silver">
                {c.title}
              </h3>
              <div className="flex items-center gap-2">
                {c.links.map((link) => (
                  <Link
                    ...
                    href={link.url}
                    target="_blank"
                    className="hover:scale-110 transition-transform duration-200 flex items-center justify-center w-3 h-3 md:w-4 md:h-4"
                  >
                    <Image
            ...
            <p className="text-xs md:text-[0.85rem] opacity-85">{c.subtitle}</p>
